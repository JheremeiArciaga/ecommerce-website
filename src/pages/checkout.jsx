      ...
      <section className="checkout">
        ...
        <span>
            {steps.map((step, index) => (
              <span key={index}>
                {index > 0 && " > "}
                <span className={index === steps.length - 1 ? "text-body-secondary" : ""}>
                  {step}
                </span>
              </span>
            ))}
            ...
            <div className="col-md-6 card  p-3 pb-4 p-sm-4 ">
              ...
              <div className="accordion" id="accordionExample">
                <div className="card">
                  ...
                  >
                    <button
                      className="btn col-12 btn-light btn-block text-start collapsed p-3 ps-4 ps-sm-5 rounded-0 border-bottom-custom"
                      type="button"
                ...
                <div className="card m-auto overflow-hidden">
                  <div className="card-header p-0">
                    <button
                      className="btn col-12 btn-light btn-block text-start p-3 ps-4 ps-sm-5 rounded-0  "
                      data-bs-toggle="collapse"
