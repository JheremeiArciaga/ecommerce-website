...
const women = () => {
  ...
  <section className="shop-banner-men ">
      ...
      <h2 className="pb-4 lh-base ">A versatile outer layer made br with <br /> stretchy fabric for <span><highlight className='py-1 px-3 fw-medium text-white'> Comport</highlight></span> </h2>
