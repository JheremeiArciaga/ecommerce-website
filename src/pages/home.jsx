          ...
          <div className="row ">
            <div className="banner-details p-md-5 d-flex flex-column   justify-content-center ">
              <div className="back-details">
                ...
                <h1 className="mt-4 d-none d-sm-none d-md-flex">
                  Best Value Deals
                </h1>
                <h2 className="d-sm-none d-none d-md-flex">On All Products</h2>
                <p className="p-2 mb-3 d-none d-sm-none d-md-flex">
                  Save more with Precious Bale
                </p>
                <Link to={"/shop"} className="button-link mt-5 ms-sm-2">
                  Shop Now
                </Link>
              </div>
            </div>
                  ...
                  <div className="col-md-8 col-lg-8">
                    <div className="card-body p-lg-5 align-items-center ">
                      ...
                      <h2 className="card-text mb-2">
                        {" "}
                        <strong>Just Wait at Home</strong>{" "}
                      </h2>
                      <p className="card-text mb-2 mx-3">
                        <small className="text-body-secondary ">
                          The latest best collection in our closet Feel Cute
                          with our outfits Lorem ipsum dolor sit amet. Lorem
                ...
                <div className="row g-0">
                  ...
                  <div className="col-md-8">
                    <div className="card-body text-sm-center text-md-start w-10 p-lg-5">
                      ...
                      <p className="card-text mb-2 mx-3">
                        <small className="text-body-secondary ">
                          Get your orders faster than before. UNIQLO now offers
