...
const cartItemCount = cartItems[id];
  ...
  <span className='text-black fs-5'>&#8369;</span> {price} <span className="text-danger"> &nbsp;<strike>{price * 2}</strike></span>
  </p>
...
<div className='col-6 d-flex align-items-center justify-content-around'>
<button className='add-btn' onClick={() => addToCart(id)}>Add To Cart {cartItemCount > 0 && `(${cartItemCount})`} </button>
</div>
